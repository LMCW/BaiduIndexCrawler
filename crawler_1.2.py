...
def getIndex(keyword):
	...
	for line in content:
		...
		indexFile = open("./baidu/data/index_"+province+'_'+city+".txt", "w", encoding='UTF-8')
			...
			for year in range(2011,2018):
				...
				for half in halfYear:
					...
					for y_data in yarray:
						...
						realD = round(a_param * float(y_data) + b_param)
